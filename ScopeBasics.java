...
public class ScopeBasics {
    ...
    // local scope: only class-scoped variables and its own local 
    // variable calles localScope2
    public static void demonstrateScope(){
        System.out.println("Inside demonstration");
        ...
        classScopedVar = "Ican be changed in any method.";
    ...
    public static void main(String[] args){
        ...
        String localScop1 = "I'm local to main";
